...
HierarchyCircularNode<DataNode> root = HierarchyCircularNode(
  data: DataNode(name: 'Root'),
  children: [
    HierarchyCircularNode(data: DataNode(name: 'child1'), children: []),
    HierarchyCircularNode(data: DataNode(name: 'child2'), children: [
      HierarchyCircularNode(data: DataNode(name: 'grandchild1'), children: [
        HierarchyCircularNode(
            data: DataNode(name: "grand_grandchild1_1"), children: []),
        HierarchyCircularNode(
            data: DataNode(name: "grand_grandchild1_2"), children: []),
      ]),
      HierarchyCircularNode(data: DataNode(name: 'grandchild2'), children: [
        HierarchyCircularNode(
